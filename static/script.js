...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>IMT Helper</h1>
                            <p>Start a conversation and ask about IMT.<br> Your chat history will be displayed here.</p>
                        </div>`
...
//da definire la irò cprretta
    const API_URL = "http://10.181.100.6:3000/chat";
